...
import eventos.click.EventoClickInvocadorRankLOL;
import jtextfield.focus.EventoFocus;

public class JPainelRankLOL extends PainelBasicos{
	...
	public JPainelRankLOL(int x, int y, int widght, int height, String color,JPanel cards) {
	...
	private void iniciar() {
		...
		botao.addActionListener(new EventoClickInvocadorRankLOL(senhaAPI, nomeCampeao, nomeInvocador, tierInvocador,
