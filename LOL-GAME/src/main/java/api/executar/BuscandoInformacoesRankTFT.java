...
public class BuscandoInformacoesRankTFT {
	//Metodo Construtor
		public BuscandoInformacoesRankTFT() {
			
		}
		public JSONArray DadosAPI(String idInvocador,String tokenAPI) throws IOException {
			String url = String.format("https://br1.api.riotgames.com/tft/league/v1/entries/by-summoner/%s",idInvocador);
			Api api = new Api(url);
